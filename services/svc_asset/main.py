...
from services.svc_asset.config import parse_args
from services.svc_asset.server_builder import AssetServerBuilder
from common.log import get_logger

logger = get_logger("asset_main")

def main():
    config = parse_args()

    builder = AssetServerBuilder()
    server = (builder
    ...
    server.start()
    logger.info(f"资产服务启动成功，端口: {config['listen_port']}")
