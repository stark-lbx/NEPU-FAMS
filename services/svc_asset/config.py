...
def parse_args():
    parser = argparse.ArgumentParser(description="资产管理子服务")

    parser.add_argument("--listen_port", type=int, default=9992)
    ...
    parser.add_argument("--service_name", type=str, default="asset")
    parser.add_argument("--service_addr", type=str, default="127.0.0.1:9992")
